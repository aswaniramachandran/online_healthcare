...
insert  into `disease`(`diseaseid`,`disease`,`details`) values (2,'covid19','headache');
...
insert  into `doctor`(`doctorid`,`loginid`,`firstname`,`lastname`,`image`,`place`,`phone`,`email`,`qualification`) values (6,13,'Aswani','M','static/4330f029-4f3b-4f20-a2f9-5789440998a1addition.PNG','asxdcv','8086388815','aswaniramachandran@gmail.com','as'),(2,12,'Aswani','M','static/abf63505-874b-459e-88cb-fe9fc142ffa4','swwewe','18086388815','aswanimnbr@gmail.com','as');
...
insert  into `login`(`loginid`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'Aswani','asdxcf','user'),(3,'Aswani','asdxcf','user'),(4,'admin','Aswani','hospital'),(5,'admin','Ammu123','hospital'),(6,'admin','Aswani','hospital'),(7,'jjked4r','nnee','hospital'),(13,'admin','Aswani','doctor'),(9,'admin','admin','doctor'),(12,'d','d','doctor');
...
insert  into `symptoms`(`symptomsid`,`diseaseid`,`symptoms`) values (1,2,'sssss'),(2,2,'vvvv');
